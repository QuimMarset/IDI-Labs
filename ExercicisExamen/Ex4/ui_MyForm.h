...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(horizontalSlider, SIGNAL(valueChanged(int)), widget, SLOT(repZoom(int)));
        QObject::connect(widget, SIGNAL(enviaZoom(int)), horizontalSlider, SLOT(setValue(int)));
