...
void MyGLWidget::initializeGL ()
{
  ...
  tipusFocus = 1; // 0 escena 1 camera
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
  ...
  switch (event->key()) {
    ...
    case Qt::Key_L: {
      if (tipusFocus == 0) emit enviaFocusCamera();
      else emit enviaFocusEscena();
      tipusFocus = 1 - tipusFocus;
      glUniform1i(tipusFocusLoc,tipusFocus);
      break;
    }
...
void MyGLWidget::repFocusEscena() {
  makeCurrent();
  tipusFocus = 0;
  glUniform1i(tipusFocusLoc,tipusFocus);
  update();
...
void MyGLWidget::repFocusCamera() {
  makeCurrent();
  tipusFocus = 1;
  glUniform1i(tipusFocusLoc,tipusFocus);
  update();
