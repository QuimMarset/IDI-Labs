...
void MyGLWidget::initializeGL ()
{
  ...
  //viewTransform ();
  iniCamera();
  glUniform1i(canviFocusLoc,tipusFocus);
}
...
void MyGLWidget::viewTransform ()
{
  if (not canviCamera) {
    ...
    glm::vec3 OBS = glm::vec3(-4.0,1.5,4.0);
...
void MyGLWidget::carregaShaders()
{
  ...
  canviFocusLoc = glGetUniformLocation(program->programId(),"tipusFocus");
}
