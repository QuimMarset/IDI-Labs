...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    float escalaPat1,escalaPat2;
    // radi de l'escena
    float radiEsc;

    glm::mat4 View;

    float rav,zN,zF,angleCamera,dist;
    glm::vec3 puntMaximEscena,puntMinimEscena;

    float angleGir,posX,posZ;

    bool canviCamera; //false com estava els exs anteriors 1 sobre el Patricio
    bool tipusFocus; //1 escena 0 camera
