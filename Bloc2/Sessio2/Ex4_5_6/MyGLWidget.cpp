...
void MyGLWidget::modelTransformPatricio () 
{
  ...
  transform = glm::translate(transform,-centreCapsaModel);
...
void MyGLWidget::calculaParametres() {
  ...
  puntMaximCapsaEscena = puntMaximCapsaModel;
  puntMinimCapsaEscena = puntMinimCapsaModel;
